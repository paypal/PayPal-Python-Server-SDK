...
class ApplePayPaymentObject(object):
    ...
    Attributes:
        ...
        token (str): Encrypted ApplePay token, containing card information. This
            token would be base64encoded. The pattern is defined by an external party
        ...
        card (ApplePayCardResponse): The Card from Apple Pay Wallet used to fund the
            payment.
        attributes (ApplePayAttributesResponse): Additional attributes associated
            with the use of Apple Pay.
    ...
    def from_dictionary(cls,
        ...
        card =\
            ApplePayCardResponse.from_dictionary(
                dictionary.get("card"))\
                if "card" in dictionary.keys()\
                else APIHelper.SKIP
        attributes =\
            ApplePayAttributesResponse.from_dictionary(
