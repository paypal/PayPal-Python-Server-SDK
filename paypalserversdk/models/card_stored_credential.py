...
class CardStoredCredential(object):
    ...
    def from_dictionary(cls,
        ...
        previous_network_transaction_reference = NetworkTransaction.from_dictionary(dictionary.get('previous_network_transaction_reference')) if 'previous_network_transaction_reference' in dictionary.keys() else APIHelper.SKIP
