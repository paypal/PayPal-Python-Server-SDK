...
class CreateSubscriptionRequest(object):
    ...
    Attributes:
        ...
        application_context (SubscriptionApplicationContext): DEPRECATED. The
            application context, which customizes the payer experience during the
    ...
    def from_dictionary(cls,
        ...
        subscriber =\
            SubscriberRequest.from_dictionary(
                dictionary.get("subscriber"))\
                if "subscriber" in dictionary.keys()\
                else APIHelper.SKIP
        auto_renewal =\
            dictionary.get("auto_renewal")\
            if dictionary.get("auto_renewal")\
                else False
        application_context =\
            SubscriptionApplicationContext.from_dictionary(
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"auto_renewal={_auto_renewal!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"auto_renewal={_auto_renewal!s}, "
