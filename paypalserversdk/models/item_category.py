...
class ItemCategory(object):
    ...
    Attributes:
        DIGITAL_GOODS: Goods that are stored, delivered, and used in their electronic
            format. This value is not currently supported for API callers that
            leverage the PayPal for Commerce Platform product.
