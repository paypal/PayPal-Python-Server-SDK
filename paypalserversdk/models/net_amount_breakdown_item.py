...
class NetAmountBreakdownItem(object):
    ...
    Attributes:
        payable_amount (Money): The currency and amount for a financial transaction,
    ...
    def from_dictionary(cls,
        ...
        payable_amount =\
            Money.from_dictionary(
                ...
                if "payable_amount" in dictionary.keys()\
                else APIHelper.SKIP
        converted_amount =\
            Money.from_dictionary(
                dictionary.get("converted_amount"))\
                if "converted_amount" in dictionary.keys()\
                else APIHelper.SKIP
        exchange_rate =\
    ...
    def __repr__(self):
        ...
        _payable_amount=(
            self.payable_amount
            if hasattr(self, "payable_amount")
            else None
        )
        _converted_amount=(
            self.converted_amount
            if hasattr(self, "converted_amount")
            else None
        )
        _exchange_rate=(
            self.exchange_rate
        ...
        return (
            ...
            f"payable_amount={_payable_amount!r}, "
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"payable_amount={_payable_amount!s}, "
