...
class OrderConfirmApplicationContext(object):
    ...
    Attributes:
        brand_name (str): Label to present to your payer as part of the PayPal hosted
            web experience.
        ...
        cancel_url (str): The URL where the customer is redirected after the customer
            cancels the payment.
        stored_payment_source (StoredPaymentSource): Provides additional details to
            process a payment using a `payment_source` that has been stored or is
