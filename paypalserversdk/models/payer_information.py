...
class PayerInformation(object):
    ...
    Attributes:
        ...
        phone_number (Phone): The phone number, in its canonical international [E.164
            numbering plan format](https://www.itu.int/rec/T-REC-E.164/en).
        address_status (str): The address status of the payer. Value is either: Y.
            Verified. N. Not verified.
    ...
    def from_dictionary(cls,
        ...
        address_status =\
            ...
            if dictionary.get("address_status")\
                else APIHelper.SKIP
        payer_status =\
            dictionary.get("payer_status")\
            if dictionary.get("payer_status")\
                else APIHelper.SKIP
        payer_name =\
            PayerName.from_dictionary(
                dictionary.get("payer_name"))\
                if "payer_name" in dictionary.keys()\
                else APIHelper.SKIP
        country_code =\
    ...
    def __repr__(self):
        ...
        _address_status=(
            self.address_status
            if hasattr(self, "address_status")
            else None
        )
        _payer_status=(
            self.payer_status
        ...
        return (
            ...
            f"address_status={_address_status!r}, "
            f"payer_status={_payer_status!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"address_status={_address_status!s}, "
            f"payer_status={_payer_status!s}, "
