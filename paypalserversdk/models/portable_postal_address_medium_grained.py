...
class PortablePostalAddressMediumGrained(object):

    """Implementation of the 'Portable Postal Address (Medium-Grained)' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PortablePostalAddressMediumGrained class"""
