...
class SetupTokenRequestCard(object):
    ...
    def from_dictionary(cls,
        ...
        experience_context = VaultCardExperienceContext.from_dictionary(dictionary.get('experience_context')) if 'experience_context' in dictionary.keys() else APIHelper.SKIP
