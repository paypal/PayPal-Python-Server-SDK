...
class ShippingWithTrackingDetails(object):
    ...
    Attributes:
        trackers (List[OrderTrackerResponse]): An array of trackers for a transaction.
        ...
        phone_number (PhoneNumberWithOptionalCountryCode): The phone number in its
        ...
        options (List[ShippingOption]): An array of shipping options that the payee
            or merchant offers to the payer to ship or pick up their items.
    ...
    def from_dictionary(cls,
        ...
        phone_number =\
            PhoneNumberWithOptionalCountryCode.from_dictionary(
