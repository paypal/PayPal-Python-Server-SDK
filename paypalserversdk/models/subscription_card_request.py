...
class SubscriptionCardRequest(object):
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionCardRequest class"""
    ...
    def from_dictionary(cls,
        ...
        attributes = SubscriptionsCardAttributes.from_dictionary(dictionary.get('attributes')) if 'attributes' in dictionary.keys() else APIHelper.SKIP
