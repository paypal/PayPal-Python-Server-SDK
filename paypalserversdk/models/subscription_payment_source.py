...
class SubscriptionPaymentSource(object):
    ...
    def __init__(self,
                 card=APIHelper.SKIP):
        """Constructor for the SubscriptionPaymentSource class"""
    ...
    def from_dictionary(cls,
        ...
        card = SubscriptionCardRequest.from_dictionary(dictionary.get('card')) if 'card' in dictionary.keys() else APIHelper.SKIP
