...
class SubscriptionsCardAttributes(object):
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionsCardAttributes class"""
    ...
    def from_dictionary(cls,
        ...
        customer = CardCustomer.from_dictionary(dictionary.get('customer')) if 'customer' in dictionary.keys() else APIHelper.SKIP
