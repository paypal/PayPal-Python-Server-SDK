...
class VaultPaypalWalletRequest(object):
    ...
    Attributes:
        ...
        customer_type (PaypalPaymentTokenCustomerType): The customer type associated
            ...
            consumer.
        billing_plan (Plan): The merchant level Recurring Billing plan metadata for
            the Billing Agreement.
        experience_context (VaultExperienceContext): A resource representing an
            experience context of vault PayPal Wallet.
