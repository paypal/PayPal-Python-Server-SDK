...
class VaultVenmoRequest(object):
    ...
    def from_dictionary(cls,
        ...
        experience_context = VenmoExperienceContext.from_dictionary(dictionary.get('experience_context')) if 'experience_context' in dictionary.keys() else APIHelper.SKIP
