...
class VenmoWalletVaultAttributes(object):
    ...
    Attributes:
        ...
        description (str): The description displayed to Venmo consumer on the
            approval flow for Venmo, as well as on the Venmo payment token management
            experience on Venmo.com.
        usage_pattern (VenmoPaymentTokenUsagePattern): Expected business/pricing
            model for the billing agreement.
        usage_type (VenmoPaymentTokenUsageType): The usage type associated with the
            Venmo payment token.
        customer_type (VenmoPaymentTokenCustomerType): The customer type associated
            with the Venmo payment token. This is to indicate whether the customer
